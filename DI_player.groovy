...
preferences {
	input("setting_server", "string", title:"Enter Logitech Media Server IP address",defaultValue:"192.168.1.110", required:false, displayDuringSetup:true)
	input("setting_port", "string", title:"Enter server port",defaultValue:"9000", required:false, displayDuringSetup:true)
	input("setting_key", "string", title:"Enter DI listening key",defaultValue:"704227736f5c04d", required:false, displayDuringSetup:true)
}

metadata {
    
	definition (name: "DI Remote", namespace: "smboards", author: "smboards") {
		capability "Actuator"
